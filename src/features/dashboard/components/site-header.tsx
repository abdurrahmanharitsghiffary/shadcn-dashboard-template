...
export function SiteHeader() {
  return (
    <header className="flex h-(--header-height) sticky top-0 bg-background z-40 shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
